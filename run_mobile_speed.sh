...
# python main_mobile.py --task cifar10_cnum50_dist3_skew0.8_seed0 --sample active --model mlp --algorithm fed_edgeavg --num_edges 5 --num_clients 50 --std_num_clients 10 --num_rounds 150 --num_epochs 1 --learning_rate 0.01 --momentum 0.9 --proportion 1 --batch_size 10 --eval_interval 1 --gpu 3 --server_gpu_id -1 --num_threads 1

python main_mobile.py --task cifar10_cnum50_dist3_skew0.8_seed0 --mean_velocity 25 --std_velocity 5 --sample active --model mlp --algorithm fed_edgeavg --num_edges 5 --num_clients 50 --std_num_clients 10 --num_rounds 150 --num_epochs 1 --learning_rate 0.01 --momentum 0.9 --proportion 1 --batch_size 10 --eval_interval 1 --gpu 3 --server_gpu_id -1 --num_threads 1
python main_mobile.py --task cifar10_cnum50_dist3_skew0.8_seed0 --mean_velocity 50 --std_velocity 10 --sample active --model mlp --algorithm fed_edgeavg --num_edges 5 --num_clients 50 --std_num_clients 10 --num_rounds 150 --num_epochs 1 --learning_rate 0.01 --momentum 0.9 --proportion 1 --batch_size 10 --eval_interval 1 --gpu 3 --server_gpu_id -1 --num_threads 1
python main_mobile.py --task cifar10_cnum50_dist3_skew0.8_seed0 --mean_velocity 200 --std_velocity 25  --sample active --model mlp --algorithm fed_edgeavg --num_edges 5 --num_clients 50 --std_num_clients 10 --num_rounds 150 --num_epochs 1 --learning_rate 0.01 --momentum 0.9 --proportion 1 --batch_size 10 --eval_interval 1 --gpu 3 --server_gpu_id -1 --num_threads 1
python main_mobile.py --task cifar10_cnum50_dist3_skew0.8_seed0 --mean_velocity 300 --std_velocity 25  --sample active --model mlp --algorithm fed_edgeavg --num_edges 5 --num_clients 50 --std_num_clients 10 --num_rounds 150 --num_epochs 1 --learning_rate 0.01 --momentum 0.9 --proportion 1 --batch_size 10 --eval_interval 1 --gpu 3 --server_gpu_id -1 --num_threads 1

python main_mobile.py --task cifar10_cnum50_dist3_skew0.8_seed0 --iid False --mean_velocity 0 --std_velocity 0 --sample active --model mlp --algorithm rand_fed_edgeavg --num_edges 5 --num_clients 50 --std_num_clients 10 --num_rounds 150 --num_epochs 1 --learning_rate 0.01 --momentum 0.9 --proportion 1 --batch_size 10 --eval_interval 1 --gpu 3 --server_gpu_id -1 --num_threads 1

python main_mobile.py --task cifar10_cnum50_dist3_skew0.8_seed0 --mean_velocity 0 --std_velocity 0 --sample active --model mlp --algorithm fed_edgeavg --num_edges 5 --num_clients 50 --std_num_clients 10 --num_rounds 150 --num_epochs 1 --learning_rate 0.01 --momentum 0.9 --proportion 1 --batch_size 10 --eval_interval 1 --gpu 3 --server_gpu_id -1 --num_threads 1
