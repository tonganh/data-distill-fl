...
python main_mobile.py --task cifar10_cnum50_dist3_skew0.8_seed0 --sample active --model mlp --algorithm fed_client_direct --num_edges 5 --num_clients 50 --std_num_clients 10 --num_rounds 500 --num_epochs 1 --learning_rate 0.01 --momentum 0.9 --proportion 1 --batch_size 10 --eval_interval 1 --gpu 3 --server_gpu_id 1 --num_threads 1
